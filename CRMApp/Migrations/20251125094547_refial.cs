...
{
    /// <inheritdoc />
    public partial class refial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatConversationParticipant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatConversationParticipant_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerInteractions_AspNetUsers_CreatedById",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerInteractions_AspNetUsers_PerformedById",
            ...
            migrationBuilder.CreateTable(
                name: "CustomerInteractionCategories",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerInteractionCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerInteractionCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerInteractionCategories_CustomerInteractions_CustomerInteractionId",
                        column: x => x.CustomerInteractionId,
                        principalTable: "CustomerInteractions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CustomerInteractionProducts",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerInteractionProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerInteractionProducts_CustomerInteractions_CustomerInteractionId",
                        column: x => x.CustomerInteractionId,
                        principalTable: "CustomerInteractions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerInteractionProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "CustomerInteractionReferrals",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerInteractionReferrals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerInteractionReferrals_AspNetUsers_AssignedToId",
                        column: x => x.AssignedToId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerInteractionReferrals_AspNetUsers_ReferredById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatConversationParticipant_ConversationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractionCategories_CategoryId",
                table: "CustomerInteractionCategories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractionCategories_CustomerInteractionId_CategoryId",
                table: "CustomerInteractionCategories",
                columns: new[] { "CustomerInteractionId", "CategoryId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractionProducts_CustomerInteractionId_ProductId",
                table: "CustomerInteractionProducts",
                columns: new[] { "CustomerInteractionId", "ProductId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractionProducts_ProductId",
                table: "CustomerInteractionProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractionReferrals_AssignedToId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractionReferrals_ReferredById",
                table: "CustomerInteractionReferrals",
                column: "ReferredById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractions_CreatedById",
                table: "CustomerInteractions",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractions_PerformedById",
                table: "CustomerInteractions",
